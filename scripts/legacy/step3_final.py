...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp", choices=['efficiency', 'accuracy', 'pruning', 'all'], required=True)
    parser.add_argument("--dataset", default=None, help="Specific dataset to run, else run all discovered.")
    ...
    for ds in target_datasets:
        try:
            ...
            if args.exp in ['efficiency', 'all']: all_results.append(orch.run_efficiency())
            if args.exp in ['accuracy', 'all']: all_results.extend(orch.run_accuracy())
            if args.exp in ['pruning', 'all']: all_results.append(orch.run_pruning())
